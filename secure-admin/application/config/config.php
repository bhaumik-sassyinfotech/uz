...
|
*/
//$config['base_url'] = 'http://'.$_SERVER['HTTP_HOST'].'/sbcrm/secure-admin/';
$config['base_url'] = 'http://'.$_SERVER['HTTP_HOST'].'/upzurge/secure-admin/';
...
$config['sess_cookie_name'] = 'sbscrm_adm';
