                        ...
                        <form name="cmsListForm" id="cmsListForm">
                            <table  class="display table table-bordered table-striped icon-color-blk drag-row" id="dynamic-table">
                                ...
                                <tbody class="drag-body">
                                    <?php
                                    $totalData = count($newsletterData);
                                    $i = 1;
                                    foreach ($newsletterData as $data):
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url('newsletter');?>/view/<?php echo $data['id'];?>"><i class="fa fa-eye tooltips" data-trigger="hover" data-toggle="tooltip" title="View Info" data-original-title="view"></i></a></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    endforeach;
