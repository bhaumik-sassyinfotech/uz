            ...
            <section class="panel">
                <header class="panel-heading pd-btm-25px">
                    ...
                    <div class="btn-group pull-right">
                        <a href="<?php echo base_url('users/addEdit'); ?>" id="editable-sample_new" class="btn btn-primary"> Add New <i class="fa fa-plus"></i> </a></div>
                </header>
                                ...
                                if (!empty($dataList)) {
                                    foreach ($dataList as $key => $data) { ?>
                                        <tr>
                                            ...
                                            <td width="11%">
                                                <div>
                                                    <a href="<?php echo base_url() . 'users/addEdit/' . $data['user_id']; ?>" title="Edit"><i class="fa fa-edit" data-trigger="hover" data-toggle="tooltip" data-original-title="Edit"></i> </a>
                                                    |
