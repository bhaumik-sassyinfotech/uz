            ...
            <div class="al-table-col col-md-9 col-sm-9 col-xs-12">
                <div class="my-advertisement-tab">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class=""><a href="<?php echo base_url('customer/advertisements'); ?>" aria-controls="profile" role="tab">Scheduled</a></li>
                        <li role="presentation" class=""><a href="<?php echo base_url('customer/ads_live'); ?>" aria-controls="live" role="tab">Live </a></li>
                        <li role="presentation" class="active"><a href="#" aria-controls="exhausted" role="tab">Exhausted</a></li>
                    </ul>
                    <!-- Tab panes -->

                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="exhausted">
                            <div class="al-right-contener">
                                <div class="al-right-content">
                                    <div class="table-pannel1">
                                            <?php if (empty($exhausted)) {
                                                echo "<h1 class='al-right-contener-head no-content'>No Ads are exhausted currently.</h1>";
                                            } else {
                                                    ...
                                                    <div class="col-md-6 col-sm-6 box schedule">
                                                        <div class="media">
                                                            ...
                                                            <div class="col-md-3 price">
                                                             ...
                                                             <div class="hidden-xs visible-sm visible-md visible-lg"><?php echo $ads['website_name']; ?></p></div>
                                                        </div>
                                                    </div>
                                                    <?php
                                                }
