            ...
            <div class="al-table-col col-md-9 col-sm-9 col-xs-12">
                <div class="my-advertisement-tab">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="active"><a href="#live" aria-controls="live" role="tab">Live </a></li>
                            ...
                            <div class="al-right-contener">
                                ...
                                <div class="al-right-content">
                                    <div class="table-pannel1">
                                            <?php if (empty($live)) {
                                                echo "<h1 class='al-right-contener-head no-content'>No Ads are live currently.</h1>";
                                            } else {
                                                foreach ($live as $ads)
                                                {
                                                    ?>
